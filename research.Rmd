...
1. 2024. Díaz, Ileana, **Leandro Zipitría** (eds.). *Empresas estatales cubanas. Situación y propuestas de transformación*. Universidad de la Habana and Udelar.  

1. 2016. Domingo, Rosario, Jorge Ponce y **Leandro Zipitría**. *Regulación económica para economías en desarrollo*. Universidad de la República. Available [here](files/2016.Libro Regulacion FINAL.pdf). Also available at the following web [page](http://leandro-zipitria.com/libro-regulacion/), and can be download from [Github](https://github.com/LeandroZipitria/libro-regulacion).
...
1. 2024. Borraz, Fernando and **Leandro Zipitría**. [Assessing long run price convergence in retailing](https://www.econstor.eu/bitstream/10419/289780/1/GLO-DP-1424.pdf), GLO Discussion Paper Series 1424. [Codes](https://github.com/LeandroZipitria/Convergence). (Submitted).
...
<<<<<<< HEAD
1. 2024. Borraz, Fernando and **Leandro Zipitría**. [Borders, Local Brands, and Price Convergence](files/2024.07 Borders local brands and price convergence.pdf).
=======
1. 2024. Borraz, Fernando and **Leandro Zipitría**. [Borders, Local Brands, and Price Convergence](files/2024.07 Borders local brands and price convergence.pdf). (Submitted).
>>>>>>> fcf0ff7 (review research July 2024)

1. 2024. Klaczko, Iael, Matías Brum and **Leandro Zipitría**. [Prices are Higher in Poor Markets](files/2024.06 PPM_Uy.pdf). (To be revised.)
