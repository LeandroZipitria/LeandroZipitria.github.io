...
1. 2026. Borraz, Fernando and **Leandro Zipitría**. [Long-Run Retail Price Dispersion: Dynamics, Market Structure, and Chain Pricing](files/2026_Long Run Retail Price Dispersion.pdf). (Submited).

1. 2025. Borraz, Fernando and **Leandro Zipitría**. [The Border Effect on Prices: The Role of Local
Product Availability](files/2025 border effect on prices.pdf). (Submitted).
